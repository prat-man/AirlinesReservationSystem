			...
			<form class="form-horizontal" action="/ars/confirmBooking" method="post">
				<div class="form-group">
					<table border="2" align="center">
						<tr align="center">
							<th><label class="control-label">Enter 16-digit Credit Card Number:</label></th>
							<th><div class="col-sm-10"><input class="form-control" id="focusedInput"
									type="text" name="creditCardInfo" pattern=".{16}" required></div></th>
						</tr>
						<tr align="right">
							<th colspan="2">
